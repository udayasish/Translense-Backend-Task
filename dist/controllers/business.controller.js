...
export const createBusiness = asyncHandler(async (req, res) => {
    ...
    if ([businessName, country, state, city, address, openingTime, closingTime, email, mobile].some((field) => !field?.trim())) {
    ...
    const emailResponse = await sendVerificationEmail(businessName, email, verifyCode);
